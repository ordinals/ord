...
<details>
  <summary>
    <code>GET</code>
    <code><b>/galleries/&lt;PAGE&gt;</b></code>
  </summary>

### Description

Pagination allows you to choose which page of 100 galleries to return.

### Example

```bash
curl -s -H "Accept: application/json" \
  http://0.0.0.0/galleries/1
```
