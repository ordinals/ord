...
and the inscription is made on the first sat of its input if there's no pointer
tag specified. This sat can then be tracked using the familiar rules of ordinal 
