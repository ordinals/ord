...
use {
  ...
  bitcoincore_rpc::json::{
    ...
    GetNetworkInfoResult, GetRawTransactionResult, GetRawTransactionResultVoutScriptPubKey,
    ...
    SignRawTransactionInput, SignRawTransactionResult, Timestamp, WalletTxInfo,
  },
