...
<dl>
  ...
  <dt>address</dt>
  <dd><a href=/address/bc1.*>bc1.*</a></dd>
  <dt>value</dt>
  <dd>10000</dd>
  <dt>preview</dt>
...
fn inscription_page_after_send() {
  ...
  ord.assert_response_regex(
    format!("/inscription/{inscription}"),
    format!(
      r".*<h1>Inscription 0</h1>.*<dt>address</dt>\s*<dd><a href=/address/bc1qcqgs2pps4u4yedfyl5pysdjjncs8et5utseepv>bc1qcqgs2pps4u4yedfyl5pysdjjncs8et5utseepv</a></dd>.*<dt>location</dt>\s*<dd class=monospace>{txid}:0:0</dd>.*",
    ),
  )
}
