...
fn batch_inscribe_with_satpoints_with_parent() {
  ...
  let sat_1 = serde_json::from_str::<api::OutputInfo>(
    &ord
  ...
  let sat_2 = serde_json::from_str::<api::OutputInfo>(
    &ord
  ...
  let sat_3 = serde_json::from_str::<api::OutputInfo>(
    &ord
...
fn batch_inscribe_with_satpoints_with_different_sizes() {
  ...
  let output_1 = serde_json::from_str::<api::OutputInfo>(
    &ord
      .json_request(format!("/output/{}", satpoint_1.outpoint))
      .text()
      .unwrap(),
  ...
  let output_2 = serde_json::from_str::<api::OutputInfo>(
    &ord
      .json_request(format!("/output/{}", satpoint_2.outpoint))
      .text()
      .unwrap(),
  ...
  let output_3 = serde_json::from_str::<api::OutputInfo>(
    &ord
      .json_request(format!("/output/{}", satpoint_3.outpoint))
      .text()
      .unwrap(),
