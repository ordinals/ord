...
fn first_satoshi() -> Result {
  Test::new()?
    .command("find --blocksdir blocks --ordinal 0 --as-of-height 0")
...
fn first_satoshi_slot() -> Result {
  Test::new()?
    .command("find --blocksdir blocks --ordinal 0 --as-of-height 0 --slot")
...
fn second_satoshi() -> Result {
  Test::new()?
    .command("find --blocksdir blocks --ordinal 1 --as-of-height 0")
...
fn second_satoshi_slot() -> Result {
  Test::new()?
    .command("find --blocksdir blocks --ordinal 1 --as-of-height 0 --slot")
...
fn first_satoshi_of_second_block() -> Result {
  Test::new()?
    .command("find --blocksdir blocks --ordinal 5000000000 --as-of-height 1")
...
fn first_satoshi_of_second_block_slot() -> Result {
  Test::new()?
    .command("find --blocksdir blocks --ordinal 5000000000 --as-of-height 1 --slot")
...
fn first_satoshi_spent_in_second_block() -> Result {
  Test::new()?
    .command("find --blocksdir blocks --ordinal 0 --as-of-height 1")
...
fn first_satoshi_spent_in_second_block_slot() -> Result {
  Test::new()?
    .command("find --blocksdir blocks --ordinal 0 --as-of-height 1 --slot")
