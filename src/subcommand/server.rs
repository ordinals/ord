...
",
  ...
  fn content_security_policy_with_origin() {
    ...
    assert_eq!(headers["content-security-policy"], HeaderValue::from_static("default-src https://ordinals.com/content/ https://ordinals.com/blockheight https://ordinals.com/blockhash https://ordinals.com/blockhash/ https://ordinals.com/blocktime https://ordinasl.com/r/ 'unsafe-eval' 'unsafe-inline' data: blob:"));
  }
