use {
    bitcoin::{
        ...
        util::key::PrivateKey,
        util::sighash::{Prevouts, SighashCache}, util::taproot::{LeafVersion, TapLeafHash, TaprootBuilder}, Witness,
    },
...
impl Inscribe {
    pub(crate) fn run(self, options: Options) -> Result {
        ...
        if bitcoin_version < MIN_BITCOIN_VERSION {
            bail!("Bitcoin Core version {} or greater required. Current Bitcoin Core reports version {}", format_bitcoin_core_version(MIN_BITCOIN_VERSION), format_bitcoin_core_version(bitcoin_version));
        }
