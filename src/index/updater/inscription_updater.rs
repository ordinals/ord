...
pub(super) struct InscriptionUpdater<'a, 'db, 'tx> {
  ...
  pub(super) home_inscriptions: &'a mut Table<'db, 'tx, u32, &'static InscriptionIdValue>,
  pub(super) id_to_sequence_number: &'a mut Table<'db, 'tx, &'static InscriptionIdValue, u32>,
  ...
  pub(super) sequence_number_to_entry: &'a mut Table<'db, 'tx, u32, InscriptionEntryValue<'static>>,
