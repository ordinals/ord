...
mod tests {
  ...
  fn thumbnail() {
    assert_regex_match!(
      ...
      .0.to_string(),
      "<a href=/inscription/1{64}i1><iframe sandbox=allow-scripts scrolling=no src=\"about:blank\" data-src=/preview/1{64}i1></iframe></a>",
    );
  }
  ...
  fn main() {
    assert_regex_match!(
      ...
      "<iframe sandbox=allow-scripts scrolling=no src=\"about:blank\" data-src=/preview/1{64}i1></iframe>",
    );
  }
}
