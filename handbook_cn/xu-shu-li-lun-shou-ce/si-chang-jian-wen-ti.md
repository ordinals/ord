...
所以他们作为“费用”去到挖这个区块的矿工那里。[The BIP](https://github.com/casey/ord/blob/master/bip.mediawiki) 有更为详细信息，但简而言之，交易支付的费用被视为对Coinbase交易的额外输入，并按照其对应的交易在区块中的顺序进行排序。该区块的Coinbase交易可能是这样的:
