...
```
ord --bitcoin-username foo --bitcoin-password bar server
```

Using environment variables:

```
export ORD_BITCOIN_USERNAME=foo
export ORD_BITCOIN_PASSWORD=bar
ord server
```
...
```yaml
bitcoin_username: foo
bitcoin_password: bar
```
