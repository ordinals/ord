...
To translate [the docs](https://docs.ordinals.com) we follow the i18n standard,
specifically we use this [mdBook i18n helper](https://github.com/google/mdbook-i18n-helpers).
So please read through their [HOWTO](https://github.com/google/mdbook-i18n-helpers/blob/main/USAGE.md)
...
translation and open a PR. A maintainer will then help you integrate it into out
build system.
